...
-- START automatically  generated VHDL the Mon Feb 17 15:04:38 2020 
  constant N_SLV_SYSMON: integer := 0;
  constant N_SLV_ICAP: integer := 1;
  constant N_SLV_IPROG: integer := 2;
  constant N_SLV_AXI_BRIDGE: integer := 3;
...
-- START automatically  generated VHDL the Mon Feb 17 15:04:38 2020 
    if    std_match(addr, "-------------001---0------------") then
      ...
      sel := ipbus_sel_t(to_unsigned(N_SLV_AXI_BRIDGE, IPBUS_SEL_WIDTH)); -- axi_bridge / base 0x00040000 / mask 0x00071000
