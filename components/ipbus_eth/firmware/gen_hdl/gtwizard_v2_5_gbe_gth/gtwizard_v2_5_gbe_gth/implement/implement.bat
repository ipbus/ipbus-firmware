...
COPY gtwizard_v2_5_gbe_gth_exdes.ngc .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\gtwizard_v2_5_gbe_gth_exdes.ucf -p xc7vx690t-ffg1927-2 gtwizard_v2_5_gbe_gth_exdes.ngc gtwizard_v2_5_gbe_gth_exdes.ngd
...
ECHO 'Running NGD'
map -register_duplication on -logic_opt on -timing -ol high -p xc7vx690t-ffg1927-2 -o mapped.ncd gtwizard_v2_5_gbe_gth_exdes.ngd
