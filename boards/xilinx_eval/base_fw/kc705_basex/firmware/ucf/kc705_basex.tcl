...
create_generated_clock -name eth_tx [get_pins -hier -filter {name =~ "infra/eth/phy/*/gtxe2_i/TXOUTCLK"}]
create_generated_clock -name eth_rx [get_pins -hier -filter {name =~ "infra/eth/phy/*/gtxe2_i/RXOUTCLK"}]
