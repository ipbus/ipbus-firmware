...
--               /data/tsw/firmware/ipbus-dev-zcu102-c2c/proj/zcu102_2017.4to2019.1/zcu102_2017.4to2019.1/zcu102_2017.4to2019.1.srcs/sources_1/bd/c2c_s_ipb/ip/c2c_s_ipb_clk_wiz_0_0/c2c_s_ipb_clk_wiz_0_0_sim_netlist.vhdl
-- Design      : c2c_s_ipb_clk_wiz_0_0
...
entity c2c_s_ipb_clk_wiz_0_0_c2c_s_ipb_clk_wiz_0_0_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of c2c_s_ipb_clk_wiz_0_0_c2c_s_ipb_clk_wiz_0_0_clk_wiz : entity is "c2c_s_ipb_clk_wiz_0_0_clk_wiz";
end c2c_s_ipb_clk_wiz_0_0_c2c_s_ipb_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of c2c_s_ipb_clk_wiz_0_0_c2c_s_ipb_clk_wiz_0_0_clk_wiz is
  signal clk_in1_c2c_s_ipb_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_c2c_s_ipb_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out2_c2c_s_ipb_clk_wiz_0_0 : STD_LOGIC;
  signal clkfbout_buf_c2c_s_ipb_clk_wiz_0_0 : STD_LOGIC;
  signal clkfbout_c2c_s_ipb_clk_wiz_0_0 : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clkfbout_c2c_s_ipb_clk_wiz_0_0,
      O => clkfbout_buf_c2c_s_ipb_clk_wiz_0_0
    );
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_c2c_s_ipb_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_c2c_s_ipb_clk_wiz_0_0,
      O => clk_out1
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out2_c2c_s_ipb_clk_wiz_0_0,
      O => clk_out2
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      BANDWIDTH => "OPTIMIZED",
      CLKFBOUT_MULT_F => 62.625000,
      CLKFBOUT_PHASE => 0.000000,
      CLKFBOUT_USE_FINE_PS => "FALSE",
      CLKIN1_PERIOD => 8.001000,
      CLKIN2_PERIOD => 0.000000,
      CLKOUT0_DIVIDE_F => 50.125000,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity c2c_s_ipb_clk_wiz_0_0 is
  port (
    clk_out1 : out STD_LOGIC;
    clk_out2 : out STD_LOGIC;
    reset : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of c2c_s_ipb_clk_wiz_0_0 : entity is true;
end c2c_s_ipb_clk_wiz_0_0;

architecture STRUCTURE of c2c_s_ipb_clk_wiz_0_0 is
begin
inst: entity work.c2c_s_ipb_clk_wiz_0_0_c2c_s_ipb_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
