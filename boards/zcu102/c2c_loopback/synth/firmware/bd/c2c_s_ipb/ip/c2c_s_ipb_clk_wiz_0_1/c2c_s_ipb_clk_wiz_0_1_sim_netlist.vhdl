...
-- Date        : Sun Nov  3 16:31:22 2019
-- Host        : heplnw017.pp.rl.ac.uk running 64-bit CentOS Linux release 7.7.1908 (Core)
-- Command     : write_vhdl -force -mode funcsim
--               /data/tsw/firmware/ipbus-dev-zcu102-c2c/proj/zcu102_2019.1_onlyXCI/zcu102_2019.1_onlyXCI/zcu102_2019.1_onlyXCI.srcs/sources_1/bd/c2c_s_ipb/ip/c2c_s_ipb_clk_wiz_0_1/c2c_s_ipb_clk_wiz_0_1_sim_netlist.vhdl
...
entity c2c_s_ipb_clk_wiz_0_1_c2c_s_ipb_clk_wiz_0_1_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of c2c_s_ipb_clk_wiz_0_1_c2c_s_ipb_clk_wiz_0_1_clk_wiz : entity is "c2c_s_ipb_clk_wiz_0_1_clk_wiz";
end c2c_s_ipb_clk_wiz_0_1_c2c_s_ipb_clk_wiz_0_1_clk_wiz;

architecture STRUCTURE of c2c_s_ipb_clk_wiz_0_1_c2c_s_ipb_clk_wiz_0_1_clk_wiz is
  signal clk_in1_c2c_s_ipb_clk_wiz_0_1 : STD_LOGIC;
  signal clk_out1_c2c_s_ipb_clk_wiz_0_1 : STD_LOGIC;
  signal clk_out2_c2c_s_ipb_clk_wiz_0_1 : STD_LOGIC;
  signal clkfbout_buf_c2c_s_ipb_clk_wiz_0_1 : STD_LOGIC;
  signal clkfbout_c2c_s_ipb_clk_wiz_0_1 : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clkfbout_c2c_s_ipb_clk_wiz_0_1,
      O => clkfbout_buf_c2c_s_ipb_clk_wiz_0_1
    );
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_c2c_s_ipb_clk_wiz_0_1
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_c2c_s_ipb_clk_wiz_0_1,
      O => clk_out1
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out2_c2c_s_ipb_clk_wiz_0_1,
      O => clk_out2
    );
...
entity c2c_s_ipb_clk_wiz_0_1 is
  ...
  attribute NotValidForBitStream of c2c_s_ipb_clk_wiz_0_1 : entity is true;
end c2c_s_ipb_clk_wiz_0_1;

architecture STRUCTURE of c2c_s_ipb_clk_wiz_0_1 is
begin
inst: entity work.c2c_s_ipb_clk_wiz_0_1_c2c_s_ipb_clk_wiz_0_1_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
