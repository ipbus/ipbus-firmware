...
--Command     : generate_target c2c_m_ipb_wrapper.bd
--Design      : c2c_m_ipb_wrapper
...
architecture STRUCTURE of c2c_m_ipb_wrapper is
  ...
  end component c2c_m_ipb;
begin
c2c_m_ipb_i: component c2c_m_ipb
     port map (
      axiclk_o => axiclk_o,
      axirstn_o(0) => axirstn_o(0),
      dipsw_tri_i(7 downto 0) => dipsw_tri_i(7 downto 0),
      ext_rst => ext_rst,
