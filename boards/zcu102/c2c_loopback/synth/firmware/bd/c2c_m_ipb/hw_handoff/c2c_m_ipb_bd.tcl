...
################################################################
# This is a generated script based on design: c2c_m_ipb
#
...
proc create_root_design { parentCell } {
  ...
  set dipsw [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 dipsw ]
  ...
  # Create ports
  set axiclk_o [ create_bd_port -dir O -type clk axiclk_o ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {ipb_axi} \
   CONFIG.ASSOCIATED_RESET {axirstn_o:ext_rst} \
 ] $axiclk_o
  set axirstn_o [ create_bd_port -dir O -from 0 -to 0 -type rst axirstn_o ]
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_RESET {ipb_periph_rst_o:ipb_ic_rst_o} \
 ] $ipb_clk_o
  set ipb_ic_rst_o [ create_bd_port -dir O -from 0 -to 0 -type rst ipb_ic_rst_o ]
  set ipb_periph_rst_o [ create_bd_port -dir O -from 0 -to 0 -type rst ipb_periph_rst_o ]
  set irq_i [ create_bd_port -dir I -from 0 -to 0 -type intr irq_i ]
  set_property -dict [ list \
   CONFIG.PortWidth {1} \
 ] $irq_i
  ...
  set axi_firewall_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_firewall:1.0 axi_firewall_0 ]
  ...
  # Create instance: rst_ps8_0, and set properties
  ...
  # Create instance: rst_ps8_1, and set properties
  set rst_ps8_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps8_1 ]
  set_property -dict [ list \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__ACT_FREQMHZ {31.246878} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__DIVISOR0 {24} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__DIVISOR1 {1} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__FREQMHZ {31.25} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__SRCSEL {RPLL} \
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__ACT_FREQMHZ {62.493755} \
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__DIVISOR0 {12} \
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__DIVISOR1 {1} \
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__FREQMHZ {62.5} \
  ...
  connect_bd_intf_net -intf_net axi_firewall_0_M_AXI [get_bd_intf_pins axi_chip2chip_0/s_axi] [get_bd_intf_pins axi_firewall_0/M_AXI]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports dipsw] [get_bd_intf_pins axi_gpio_0/GPIO]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_pins axi_firewall_0/S_AXI] [get_bd_intf_pins axi_interconnect_0/M03_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M04_AXI [get_bd_intf_pins axi_interconnect_0/M04_AXI] [get_bd_intf_pins c2c_stat/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M05_AXI [get_bd_intf_pins axi_firewall_0/S_AXI_CTL] [get_bd_intf_pins axi_interconnect_0/M05_AXI]
  ...
  connect_bd_net -net aresetn [get_bd_ports axirstn_o] [get_bd_pins and_2/Op1] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/M05_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins c2c_stat/s_axi_aresetn] [get_bd_pins rst_ps8_0/peripheral_aresetn]
  ...
  connect_bd_net -net axi_chip2chip_0_aurora64_mmcm_not_locked_out [get_bd_pins axi_chip2chip_0/aurora_mmcm_not_locked] [get_bd_pins axi_chip2chip_0_aurora64/mmcm_not_locked_out] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net axi_chip2chip_0_aurora64_soft_err [get_bd_pins axi_chip2chip_0_aurora64/soft_err] [get_bd_pins xlconcat_0/In5]
  ...
  connect_bd_net -net axi_chip2chip_0_axi_c2c_config_error_out [get_bd_pins axi_chip2chip_0/axi_c2c_config_error_out] [get_bd_pins xlconcat_0/In6]
  connect_bd_net -net axi_chip2chip_0_axi_c2c_link_error_out [get_bd_pins axi_chip2chip_0/axi_c2c_link_error_out] [get_bd_pins xlconcat_0/In9]
  connect_bd_net -net axi_chip2chip_0_axi_c2c_link_status_out [get_bd_pins axi_chip2chip_0/axi_c2c_link_status_out] [get_bd_pins xlconcat_0/In7]
  connect_bd_net -net axi_chip2chip_0_axi_c2c_multi_bit_error_out [get_bd_pins axi_chip2chip_0/axi_c2c_multi_bit_error_out] [get_bd_pins xlconcat_0/In8]
  connect_bd_net -net c2c_rstn_i [get_bd_pins and_2/Op2] [get_bd_pins c2c_stat/gpio2_io_o]
  connect_bd_net -net c2c_rstn_o [get_bd_pins and_2/Res] [get_bd_pins axi_chip2chip_0/s_aresetn] [get_bd_pins axi_firewall_0/aresetn]
  connect_bd_net -net pl_ps_irq0_0_1 [get_bd_ports irq_i] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net reset_1 [get_bd_ports ext_rst] [get_bd_pins rst_ps8_0/ext_reset_in]
  connect_bd_net -net rst_ps8_0_96M_interconnect_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins rst_ps8_0/interconnect_aresetn]
  connect_bd_net -net rst_ps8_1_interconnect_aresetn [get_bd_pins rst_ps8_1/interconnect_aresetn] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net rst_ps8_1_peripheral_aresetn [get_bd_pins rst_ps8_1/peripheral_aresetn] [get_bd_pins util_vector_logic_1/Op1]
  ...
  connect_bd_net -net xlconcat_0_dout [get_bd_pins c2c_stat/gpio_io_i] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins rst_ps8_1/ext_reset_in] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_ports axiclk_o] [get_bd_pins axi_chip2chip_0/s_aclk] [get_bd_pins axi_firewall_0/aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins c2c_stat/s_axi_aclk] [get_bd_pins rst_ps8_0/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk2 [get_bd_ports ipb_clk_o] [get_bd_pins rst_ps8_1/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk1]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk3 [get_bd_pins axi_chip2chip_0/aurora_init_clk] [get_bd_pins axi_chip2chip_0_aurora64/init_clk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk2]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins rst_ps8_0/aux_reset_in] [get_bd_pins rst_ps8_1/aux_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]

  # Create address segments
  create_bd_addr_seg -range 0x01000000 -offset 0xA1000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_chip2chip_0/s_axi/Mem0] SEG_axi_chip2chip_0_Mem0
  create_bd_addr_seg -range 0x00001000 -offset 0xA000F000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_firewall_0/S_AXI_CTL/Control] SEG_axi_firewall_0_Control
  create_bd_addr_seg -range 0x00001000 -offset 0xA0002000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0001000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs c2c_stat/S_AXI/Reg] SEG_c2c_stat_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA0010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ipb_axi/Reg] SEG_ipb_axi_Reg
